...
export default function StakeToken() {
  ...
  return (
    <Wrapper>
      <TitlePrimaryLabel>
        Stake SYNC for upto <span>42,690% APR</span>
      </TitlePrimaryLabel>
      <TitleSecondaryLabel>42,690% APR</TitleSecondaryLabel>
      <ButtonWrapper>
        <Button>Buy $SYNC</Button>
      ...
      <DetailsWrapper>
        <StakeWrapper>
          ...
          {staking === Staking.STAKE ? (
            <ContentWrapper>
              <HeaderWrapper>
                <ContentPrimaryLabel>Amount of $SYNC to stake</ContentPrimaryLabel>
                <ContentSecondaryLabel>Available: 69,420 SYNC</ContentSecondaryLabel>
              </HeaderWrapper>
            ...
            <ContentWrapper>
              <HeaderWrapper>
                <ContentPrimaryLabel>Amount of $SYNC to unstake</ContentPrimaryLabel>
                <ContentSecondaryLabel>Staked: 42,690 SYNC</ContentSecondaryLabel>
              </HeaderWrapper>
              <InputBox currency={undefined} value={''} onChange={() => {}} showMax={true} />
              <Button style={{ width: '100%' }}>Approve</Button>
            </ContentWrapper>
        ...
        <InfoWrapper>
          <InfoPrimaryLabel>Your Stake (Compounding)</InfoPrimaryLabel>
          <InfoSecondaryLabel>420,690 SYNC</InfoSecondaryLabel>
          <InfoPrimaryLabel>Earned so far through staking</InfoPrimaryLabel>
